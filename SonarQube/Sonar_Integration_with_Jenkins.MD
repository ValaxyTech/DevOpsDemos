...
Install Sonar Scanner and sonarqube scanner plugin Jenkins to integrate sonarq+Qube server. After that confingre SonarQube server and Sonar scanner details under manage jenkins. 
